...
void help()
{
    ...
    std::cout << "- sched will run a scheduling simulator using testing.txt as input." << std::endl;                                                    //Project #2 Addition     
    std::cout << "- tlb will simulate how TLB operates in a virtual memory system, generating memory references from a .txt file." << std::endl;        //Project #3 Addition
